...
namespace AspNet.Security.OAuth.VidZapper {
    public class VidZapperAuthenticationHandler : OAuthHandler<VidZapperAuthenticationOptions> {
        public VidZapperAuthenticationHandler([NotNull] HttpClient client)
            : base(client) {
        }
